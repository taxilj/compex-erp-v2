...
async function main() {
  // Try executing SQL via raw_query (some projects have this RPC)
  // Or try directly querying the tables via REST
  const tables = ['quotations', 'quotation_items', 'sales_orders', 'so_items', 'delivery_notes', 'dn_items', 'production_orders']
